...
const BookDetails = () => {
  ...
  return (
    <div>
      <div className="card lg:card-side bg-base-100 border mx-2 md:mx-20 p-2 md:p-4">
        <figure className="p-4 bg-gray-100 md:w-1/2">
          <img
          className="w-48"
        ...
        <div className="card-body">
          ...
          <div className="flex md:w-1/2 gap-2 justify-between items-center">
          ...
          <hr/>
          <p className="flex justify-between md:w-2/3 items-center">Number of pages : <span className="font-semibold" >{totalPages}</span></p>
          <p className="flex justify-between md:w-2/3 items-center">Publisher : <span className="font-semibold" >{publisher}</span></p>
          <p className="flex justify-between md:w-2/3 items-center">Year of Publishing : <span className="font-semibold" >{yearOfPublishing}</span></p>
          <p className="flex justify-between md:w-2/3 items-center">Rating : <span className="font-semibold" >{rating}</span></p>
          <div className="card-actions justify-center md:justify-start my-2 flex gap-2">
